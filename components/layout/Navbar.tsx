  ...
  return (
    ...
    >
      ...
      <nav className="max-w-7xl mx-auto px-5 md:px-8 h-16 flex items-center gap-3 md:gap-6">
        ...
        >
          <span className="relative inline-flex items-center justify-center py-2 px-1 transition-transform group-hover:scale-105">
            <img src="/ticketpulse-logo.svg" alt="TicketPulse" className="h-7 md:h-8 w-auto" />
          </span>
        </Link>
