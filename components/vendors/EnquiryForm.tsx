    ...
    <form onSubmit={handleSubmit} noValidate className="space-y-3 mb-5">
      ...
      <div>
        ...
        <input
          ...
          className={`w-full bg-paper border rounded-xl px-3.5 py-2.5 text-[13.5px] text-ink placeholder:text-ink-3 focus:outline-none focus:ring-4 transition ${errors.name ? "border-rose-400 focus:border-rose-400 focus:ring-rose-100" : "border-line focus:border-blue focus:ring-blue/10"}`}
        />
      ...
      <div>
        ...
        <input
          ...
          className={`w-full bg-paper border rounded-xl px-3.5 py-2.5 text-[13.5px] text-ink placeholder:text-ink-3 focus:outline-none focus:ring-4 transition ${errors.email ? "border-rose-400 focus:border-rose-400 focus:ring-rose-100" : "border-line focus:border-blue focus:ring-blue/10"}`}
        />
      ...
      <div>
        ...
        <textarea
          ...
          className={`w-full bg-paper border rounded-xl px-3.5 py-2.5 text-[13.5px] text-ink placeholder:text-ink-3 focus:outline-none focus:ring-4 transition resize-none ${errors.message ? "border-rose-400 focus:border-rose-400 focus:ring-rose-100" : "border-line focus:border-blue focus:ring-blue/10"}`}
        />
