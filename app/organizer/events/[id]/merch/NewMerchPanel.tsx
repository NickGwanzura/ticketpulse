  ...
  return (
    <div className="rounded-2xl border border-dashed border-line bg-paper-2/40 p-5 md:p-6">
      <div className="flex items-start justify-between gap-3 mb-3">
        <div>
          <p className="text-[15px] font-semibold text-ink">New merch item</p>
          <p className="text-[13px] text-ink-2 mt-0.5">T-shirts, caps, posters: sell merch alongside tickets.</p>
        </div>
        <button
          type="button"
          onClick={() => setOpen((v) => !v)}
