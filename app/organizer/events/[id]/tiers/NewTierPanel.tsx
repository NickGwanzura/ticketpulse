  ...
  return (
    <div className="rounded-2xl border border-dashed border-line bg-paper-2/40 p-5 md:p-6">
      <div className="flex items-start justify-between gap-3 mb-3">
        <div>
          <p className="text-[15px] font-semibold text-ink">New ticket tier</p>
          <p className="text-[13px] text-ink-2 mt-0.5">General, VIP, early bird — set a price, capacity, and optional sales window.</p>
        </div>
        <button
          type="button"
          onClick={() => setOpen((v) => !v)}
