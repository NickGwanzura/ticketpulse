    ...
    <div className="relative">
      ...
      <section className="relative overflow-hidden border-b border-line">
        <div className="absolute inset-0 -z-10" style={{
          background: "radial-gradient(800px 320px at 50% -20%, #DBE8FB 0%, transparent 60%), radial-gradient(600px 240px at 50% 100%, rgba(141,211,47,0.10) 0%, transparent 60%), linear-gradient(180deg, #FFFFFF 0%, #F6F9FC 100%)",
        }} />
