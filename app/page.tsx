...
export default async function Home() {
  ...
  return (
    <main>
      {/* HERO */}
      <section className="relative isolate min-h-[600px] overflow-hidden bg-[#081522] text-[#fbf2e4] md:min-h-[820px]">
        <HeroBackgroundSlideshow />

        <div className="mx-auto flex min-h-[600px] max-w-7xl items-center px-5 pb-14 pt-28 sm:pb-20 md:min-h-[820px] md:px-8 md:pt-40">
