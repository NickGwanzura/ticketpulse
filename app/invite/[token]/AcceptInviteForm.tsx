        ...
        {!isSignedIn ? (
          <div className="space-y-4">
            ...
            <Link
              ...
              className="block w-full text-center rounded-xl bg-navy px-5 py-3 text-sm font-semibold text-white shadow-sm shadow-navy/20 hover:bg-navy-700 transition"
            >
