    ...
    <div className="tp-fade-up">
        ...
        <div className="max-w-5xl mx-auto px-5 md:px-8 py-8 md:py-10">
          <div className="flex items-start gap-4">
            ...
            <Link href={`/vendors/${vendor.id}`} target="_blank"
              className="shrink-0 inline-flex items-center gap-1.5 rounded-xl border border-line bg-paper px-3 py-2 text-[13px] font-medium text-ink hover:border-line-2 transition-colors">
      ...
      <div className="max-w-5xl mx-auto px-5 md:px-8 py-8 space-y-8">
        ...
        {pct < 100 && (
          <div className="rounded-2xl border border-line bg-paper p-5 tp-fade-up-1">
            <div className="flex items-center justify-between mb-3">
              <div>
                <p className="text-[14px] font-semibold text-ink">Profile completeness</p>
        ...
        <div className="tp-fade-up-2">
          <h2 className="text-[16px] font-semibold text-ink mb-5">Edit profile</h2>
          <VendorDashboardForm
            vendorId={vendor.id}
            initial={{
