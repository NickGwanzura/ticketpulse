    ...
    <div
      ...
      <div className="w-full max-w-sm">
        ...
        >
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <Link href="/auth/forgot" className="text-[13px] font-semibold text-navy hover:underline py-1 -my-1 px-1 -mx-1">Forgot?</Link>
            </div>
            <PasswordInput />
          </div>
          <button
        ...
        >
          <button
            type="submit"
            className="w-full flex items-center justify-center gap-3 rounded-2xl border border-line-2 bg-paper text-ink font-medium text-[14px] py-3.5 hover:bg-paper-2 active:scale-[0.99] transition-colors"
          >
