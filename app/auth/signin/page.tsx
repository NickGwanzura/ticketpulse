      ...
      <div className="w-full max-w-sm">
        ...
        >
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              <label className="block text-[11.5px] font-medium text-ink-2">Password</label>
              <Link href="/auth/forgot" className="text-[11.5px] font-semibold text-navy hover:underline">Forgot?</Link>
            </div>
            <div className="relative">
        ...
        <div className="rounded-2xl border border-line bg-paper p-6 space-y-3">
          ...
          >
            ...
            <button
              type="submit"
              className="w-full text-sm font-medium text-ink-2 hover:text-ink py-2 transition-colors"
            >
              Email me a link
            </button>
          </form>
