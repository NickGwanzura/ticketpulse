...
const PRICING_PERKS = [
  {
    icon: Percent,
    title: "6% per ticket sold",
    body: "We charge 6% on every ticket sale. No monthly fees, no setup costs, no hidden charges. You only pay when you sell.",
  },
  {
    icon: Banknote,
  ...
  {
    icon: Smartphone,
    title: "EcoCash & bank settlement",
    body: "Choose EcoCash settlement or add bank details for a direct USD bank transfer.",
  },
  {
    icon: ShieldCheck,
...
const FAQS = [
  {
    ...
    a: "We charge 6% of every ticket sale. There are no setup fees, no monthly subscriptions, and no hidden costs. You only pay when tickets are sold.",
  },
  {
    q: "When and how do I get paid?",
    a: "You can request a payout at any time from your organizer dashboard. Once requested, funds are sent to your selected settlement method after TicketPulse review. The 6% fee is deducted automatically.",
  },
  {
  ...
  },
  {
    ...
    a: "Buyers can pay with EcoCash or Visa card in USD. All transactions are processed securely and tickets are issued instantly upon successful payment.",
  },
  {
...
export const metadata = {
  ...
  description:
    "How TicketPulse works for event organizers. 6% per ticket, EcoCash or bank payouts, and built-in scanning.",
}
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="mt-1 text-[13px] text-ink-2 leading-relaxed max-w-xl">
                  Request a payout at any time from your dashboard. We deduct the 6% fee and transfer the balance to your selected settlement method. Your event ledger shows gross, fee, paid out, pending, and available balance before you request.
                </p>
              </div>
            </div>
            <Link
          ...
          <div className="relative grid md:grid-cols-2 gap-6 items-center">
            <div>
              ...
              <p className="mt-3 text-[15px] text-white/80 max-w-md leading-relaxed">
                No upfront fees, no monthly costs. Just 6% per ticket sold and payouts when you want them.
              </p>
            </div>
